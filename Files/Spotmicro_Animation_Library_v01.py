...
class SpotAnim:
    ...
    def animate(self, pos, t, thetax, thetaz, angle, center_x, center_y, thetalf, thetarf, thetarr, thetalr, walking_speed, walking_direction, steering, stance):
        ...
        """ Body frame lines """
        lineb = SpotAnim.display_rotate(self, x_spot[1] - x_spot[0], y_spot[1] - y_spot[0], z_spot[1] - z_spot[0], theta_spot, thetax, thetaz, [Spot.xlf, Spot.xrf, Spot.xrr, Spot.xlr, Spot.xlf], [Spot.ylf, Spot.yrf, Spot.yrr, Spot.ylr, Spot.ylf],
                                        [Spot.zlf, Spot.zrf, Spot.zrr, Spot.zlr, Spot.zlf])
